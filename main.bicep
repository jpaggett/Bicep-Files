// Created with MS Learn as a training module.
//This code allows for the creation of scalable backend infrastructure to Bicep. These resources include VMs, Storage, Networking Components, and a load balancer.
